...
\frametitle{Was ist KIWI ?}
	\begin{itemize}
		...
		\item Unterstützung bei der Aktivierung von OS Images
		\item Unterstützung von Virtualisierungssystemen (Xen)
...
\frametitle{Architektur}
	\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{intro.eps}
	\end{figure}
\end{frame}
...
\frametitle{Ein Image System}
	\begin{itemize}
		\item erfordert Kenntnisse über das Betriebssystem. Die
              notwendigen Informationen wie das Image zu erstellen ist
              müssen durch den Benutzer beschrieben werden.
		\item teilt sich auf in einen Prozess- und Managementanteil.
              KIWI implementiert den Prozessteil für
              ein Imagesystem da der Managementanteil sehr
              von dem jeweiligen Einsatzgebiet abhängt
	\end{itemize}
\end{frame}
...
\frametitle{Das OpenSuSE buildhost image}
	\begin{itemize}
		\item Stellt das Basisbetriebssystem zur Verfügung um innerhalb des
		...
		\item Alle buildhosts werden innerhalb ihres Netzes automatisch
              ...
              netboot Image zur Verfügung gestellt.
	\end{itemize}
