...
# STATUS        : Development
#----------------
package Test::kiwiXMLProductData;
...
sub test_ctor_noArg {
	...
	my $this = shift;
	my $kiwi = $this -> {kiwi};
	my $productDataObj = KIWIXMLProductData -> new($kiwi);
	my $msg = $kiwi -> getMessage();
	my $expectedMsg = 'KIWIXMLProductData: must be constructed with a '
...
sub test_ctor_unsuportedArch {
	...
	my $productDataObj = KIWIXMLProductData -> new($kiwi, \%init);
	my $msg = $kiwi -> getMessage();
...
sub test_ctor_unsupportedKW {
	...
	my $productDataObj = KIWIXMLProductData -> new($kiwi, \%init);
	my $msg = $kiwi -> getMessage();
	my $expectedMsg = 'KIWIXMLProductData: Unsupported keyword argument '
