...
# STATUS        : Development
#----------------
package Test::kiwiXMLIgnorePackageData;
...
sub test_ctor_noArg {
	...
	my $this = shift;
	my $kiwi = $this -> {kiwi};
	my $ignoreDataObj = KIWIXMLIgnorePackageData -> new($kiwi);
	my $msg = $kiwi -> getMessage();
	my $expectedMsg = 'KIWIXMLIgnorePackageData: must be constructed with a '
...
sub test_ctor_unsuportedArch {
	...
	my $ignoreDataObj = KIWIXMLIgnorePackageData -> new($kiwi, \%init);
	my $msg = $kiwi -> getMessage();
...
sub test_ctor_unsupportedKW {
	...
	my $ignoreDataObj = KIWIXMLIgnorePackageData -> new($kiwi, \%init);
	my $msg = $kiwi -> getMessage();
	my $expectedMsg = 'KIWIXMLIgnorePackageData: Unsupported keyword argument '
