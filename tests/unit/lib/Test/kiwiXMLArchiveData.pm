...
# STATUS        : Development
#----------------
package Test::kiwiXMLArchiveData;
...
sub test_ctor_noArg {
	...
	my $this = shift;
	my $kiwi = $this -> {kiwi};
	my $archiveObj = KIWIXMLArchiveData -> new($kiwi);
	my $msg = $kiwi -> getMessage();
	my $expectedMsg = 'KIWIXMLArchiveData: must be constructed with a '
...
sub test_ctor_simple {
	...
	my $archiveObj = KIWIXMLArchiveData -> new($kiwi, \%init);
	my $msg = $kiwi -> getMessage();
...
sub test_ctor_invalidBoolValIncl {
	...
	my $archiveObj = KIWIXMLArchiveData -> new($kiwi, \%init);
	my $msg = $kiwi -> getMessage();
	my $expectedMsg = 'KIWIXMLArchiveData: Unrecognized value for boolean '
...
sub test_ctor_unsupportedKW {
	...
	my $archiveObj = KIWIXMLArchiveData -> new($kiwi, \%init);
	my $msg = $kiwi -> getMessage();
	my $expectedMsg = 'KIWIXMLArchiveData: Unsupported keyword argument '
...
sub test_setBootIncludeInvalidArg {
	...
	$msg = $kiwi -> getMessage();
	my $expected = 'KIWIXMLArchiveData:setBootInclude: unrecognized '
